...
[Qwen3.6-27B source checkpoint](https://huggingface.co/Qwen/Qwen3.6-27B), converted from the fixed packed weights in
...
[Qwen3.6-27B source checkpoint](https://huggingface.co/Qwen/Qwen3.6-27B) base repository and the
