...
from tools.reference.qwen3_8_27b.config import ATTN_SCALE, CFG, VISION_CFG
from tools.reference.qwen3_8_27b.ops import (
...
from tools.reference.qwen3_8_27b.state import KVCache
from tools.reference.qwen3_8.common.vision_ops import vision_attention
