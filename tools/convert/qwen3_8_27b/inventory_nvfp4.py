"""Persistent-object contract for the additive Qwen3.8-27B NVFP4 artifact."""

from __future__ import annotations

from tools.convert.qwen3_8.common.inventory import TensorSpec

from . import base_inventory as base
