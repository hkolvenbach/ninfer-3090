...
| Task | Location |
|---|---|
| Build the 27B artifact | [`convert/qwen3_8_27b/`](convert/qwen3_8_27b/) |
...
| Run the 27B Python reference | [`reference/qwen3_8_27b/`](reference/qwen3_8_27b/README.md) |
| Run the 35B-A3B Python reference | [`reference/qwen3_6_35b_a3b/`](reference/qwen3_6_35b_a3b/README.md) |
| Compare 27B artifact/source Vision activations | [`parity/qwen3_8_27b/`](parity/qwen3_8_27b/README.md) |
...
```bash
python3 -m tools.artifact.inspect out/qwen3_8_27b.ninfer --objects
```
...
```bash
python3 -m tools.reference.qwen3_8_27b \
