...
struct VisionItemView {
    ...
    const qwen3_8::VisionItemControl* control = nullptr;
};
...
public:
    ...
    [[nodiscard]] static std::size_t workspace_bytes(const qwen3_8::VisionItemControl& item);
...
public:
    VisionPrefillSession(DeviceContext& device, const LoadedModelData& model,
                         WorkspaceArena& workspace, qwen3_8::PreparedPromptData& prompt,
...
private:
    ...
    qwen3_8::PreparedPromptData& prompt_;
