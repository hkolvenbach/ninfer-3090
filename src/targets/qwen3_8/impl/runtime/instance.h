...
#ifndef NINFER_QWEN38_VARIANT
#    error "NINFER_QWEN38_VARIANT must name the complete exact Variant"
#endif
#ifndef NINFER_QWEN38_RUNTIME_NS
#    error "NINFER_QWEN38_RUNTIME_NS must be a unique identifier for this instantiation"
#endif
...
using Variant                        = NINFER_QWEN38_VARIANT;
...
using SequencePlan    = qwen3_8::SequencePlan<Variant>;
using SequencePlanner = qwen3_8::SequencePlanner<Variant>;
using RequestBasePlan = qwen3_8::RequestBasePlan<Variant>;
using RequestPlan     = qwen3_8::RequestPlan<Variant>;
using Program         = qwen3_8::Program<Variant>;
